...
cat ./osm/sorbusdomestica.geojson | \
            ...
            ./bin/devel/process-history.js ./update-history/history.geojson  | tee sorbusdomestica.geojson |  \
	    ./bin/devel/add-growth.js > ./site/sorbusdomestica_devel.geojson
              

#cat ./site/sorbusdomestica.geojson | ./bin/devel/reduce.js | ./bin/devel/flatten-tags.js > ../sorbusdomestica.geojson
